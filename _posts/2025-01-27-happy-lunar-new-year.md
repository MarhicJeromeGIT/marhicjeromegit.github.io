...
This week it's Lunar New Year, or Tết celebrations in Vietnam. Which means my daughter's school is off, which means I get approximately 30 seconds of free time per day. Despite that, it was hard to miss the hype regarding the release of Deepseek R1. I didn't have time to read the paper or anything, but I gave it a quick try at [chat.deepseek.com](chat.deepseek.com). I still don't have a good handle on what makes a "reasoning question," but I came up with a good use case today: coming up with a memorable port number for a service I'm hosting locally.
...
Which is quite bad (it should be 4 instead of 8). The o1 model thought for 27 seconds and came up with:
...
Which was a bit better, but ultimately I went with Deepseek's 4611 to host my RSS reader, [Miniflux](https://miniflux.app/), on my Raspberry Pi.
