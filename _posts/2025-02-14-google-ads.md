...
Going to the Play Store to download "Google Translate" that somehow wasn't installed by default, the experience is that some random app appears first as an add, using almost the exact icon:
